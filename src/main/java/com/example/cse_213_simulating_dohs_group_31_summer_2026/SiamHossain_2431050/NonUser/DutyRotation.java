...
public class DutyRotation {
    ...
    public String getPreviousDuty() {return previousDuty;}

    public void setPreviousDuty(String previousDuty) {this.previousDuty = previousDuty;}
    ...
    public String getSuggestedDuty() {return suggestedDuty;}

    public void setSuggestedDuty(String suggestedDuty) {this.suggestedDuty = suggestedDuty;}
    ...
    public String getNextWeekDuty() {return nextWeekDuty;}

    public void setNextWeekDuty(String nextWeekDuty) {this.nextWeekDuty = nextWeekDuty;}
